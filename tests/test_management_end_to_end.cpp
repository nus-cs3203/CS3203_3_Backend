...
TEST_F(ManagementServerGetEndpointsTest, PollTemplatesGetAll) {
    ...
    auto doc1 = make_document(
        kvp("template_name", "Template1"),
        kvp("description", "First poll template")
    );
    auto doc2 = make_document(
        kvp("template_name", "Template2"),
...
TEST_F(ManagementServerGetEndpointsTest, PollResponsesGetOne) {
    ...
    auto doc = make_document(
        kvp("poll_id", "67da871c1447ef5cec00d5f1"),
        kvp("user_id", "67d93e8c3c0bfe14510691b1"),
        kvp("response", "Maxwell Food Centre"),
        kvp("date_submitted", "01-01-2022 00:00:00")
    );
