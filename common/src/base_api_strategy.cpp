...
auto BaseApiStrategy::process_request_func_get_one(const crow::request& req) -> std::tuple<bsoncxx::document::value, mongocxx::options::find> {
...
auto BaseApiStrategy::process_response_func_get_one(const bsoncxx::document::value& doc) -> crow::json::wvalue {
